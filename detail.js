(() => {
  ...
  function renderCustomer() {
    ...
    $("auditTimeline").innerHTML = `<div><strong>2024-03-18 09:32:00</strong><span>${store}创建客户，已完成现场拍照</span></div><div><strong>2025-11-02 14:18:00</strong><span>OP001 · 运营管理员修改客户备注</span></div><div><strong>2026-08-05 16:20:00</strong><span>${store}提交核销修改申请</span></div>`;
  }
