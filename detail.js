(() => {
  ...
  function renderCustomer() {
    ...
    $("auditTimeline").innerHTML = `<div><strong>2024-03-18</strong><span>${store}创建客户，已完成现场拍照</span></div><div><strong>2025-11-02</strong><span>OP001 · 运营管理员修改客户备注</span></div><div><strong>2026-08-05</strong><span>${store}提交补录核销申请</span></div>`;
  }
