...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v4" : "v73"', "timer-compatible versions");
...
function createTimerHarness(photoOnly) {
  ...
  vm.runInContext(
    ...
    harness,
    { filename: photoOnly ? "verification-photo-v4-timer.js" : "face-recognition-v73-timer.js" }
  );
  return {
