...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v5" : "v82"', "timer-compatible versions");
...
function createTimerHarness(photoOnly) {
  ...
  vm.runInContext(
    ...
    harness,
    { filename: photoOnly ? "verification-photo-v5-timer.js" : "face-recognition-v82-timer.js" }
  );
  return {
