...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v9" : "v109"', "timer-compatible versions");
...
function createTimerHarness(photoOnly) {
  ...
  vm.runInContext(
    ...
    harness,
    { filename: photoOnly ? "verification-photo-v9-timer.js" : "face-recognition-v109-timer.js" }
  );
  return {
