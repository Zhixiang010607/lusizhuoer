...
assert.match(cloud, /const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION \? "v3" : "v62"/);
...
assert.match(html, /auth-ui\.js\?v=0\.18\.8/);
...
assert.match(teacherHtml, /teacher-work-orders\.js\?v=0\.15\.4/);
