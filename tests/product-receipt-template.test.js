...
assert.ok(cloud.includes('const FUNCTION_VERSION = "v72"'), "staffAccount retains the resilient logo-read contract in v72");
...
assert.ok(detailHtml.includes('cloudbase-phone-auth.js?v=0.20.1'), "template page loads the current shared auth API cache key");
