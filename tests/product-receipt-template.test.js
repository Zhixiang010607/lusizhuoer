...
assert.ok(cloud.includes('const FUNCTION_VERSION = "v69"'), "staffAccount retains the resilient logo-read contract in v69");
...
assert.ok(detailHtml.includes('cloudbase-phone-auth.js?v=0.20.0'), "template page loads the current shared auth API cache key");
