...
assert.match(cloud, /const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION \? "v9" : "v106"/);
assert.match(readme, /当前版本：`v106`/);
...
assert.match(readme065, /065-01-store-optional-business-teacher\.sql[\s\S]*faceRecognition-v106\.zip[\s\S]*065-readonly-verify\.sql[\s\S]*0\.2\.43/,
