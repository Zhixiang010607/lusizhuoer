...
includes(business, 'const VERSION = "0.14.61"', "static workflow version");
...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v9" : "v97"', "cloud function version");
