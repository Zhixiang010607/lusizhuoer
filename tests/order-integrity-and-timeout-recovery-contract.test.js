...
includes(business, 'const VERSION = "0.14.59"', "static workflow version");
...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v9" : "v92"', "cloud function version");
