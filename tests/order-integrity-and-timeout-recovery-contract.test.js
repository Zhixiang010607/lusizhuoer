...
includes(business, 'const VERSION = "0.14.62"', "static workflow version");
...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v10" : "v111"', "cloud function version");
