...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v9" : "v109"', "split cloud versions");
...
includes(createUi, 'const VERSION = "0.14.62"', "create UI cache version");
...
includes(detailUi, 'const VERSION = "0.16.29"', "detail UI cache version");
...
includes(detailHtml, 'business-detail.js?v=0.16.29', "detail script cache bust");
