...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v3" : "v58"', "split cloud versions");
...
includes(detailHtml, 'styles.css?v=0.15.39', "detail styles cache bust");
