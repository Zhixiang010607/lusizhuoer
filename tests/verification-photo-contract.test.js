...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v10" : "v111"', "split cloud versions");
...
includes(detailUi, 'const VERSION = "0.16.30"', "detail UI cache version");
