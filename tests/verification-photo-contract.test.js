...
includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v3" : "v61"', "split cloud versions");
...
includes(detailUi, 'const VERSION = "0.16.7"', "detail UI cache version");
...
includes(detailHtml, 'business-detail.js?v=0.16.7', "detail script cache bust");
includes(detailHtml, 'styles.css?v=0.15.42', "detail styles cache bust");
