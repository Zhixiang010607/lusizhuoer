...
for (const page of pages) {
  ...
  includes(html, "store-business.js?v=0.14.62", `${page} workflow cache key`);
...
(async () => {
  ...
  includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v10" : "v113"', "deployable service versions");
