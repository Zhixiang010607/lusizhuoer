...
for (const page of pages) {
  ...
  includes(html, "store-business.js?v=0.14.60", `${page} workflow cache key`);
...
for (const page of teacherBusinessPages) includes(read(page), "store-business.js?v=0.14.60", `${page} shared script version`);
...
(async () => {
  ...
  includes(cloud, 'const FUNCTION_VERSION = PHOTO_ONLY_FUNCTION ? "v9" : "v94"', "deployable service versions");
