...
assert.match(html, /styles\.css\?v=0\.15\.54/);
assert.match(html, /teacher-work-orders\.js\?v=0\.16\.0/);
...
assert.match(css, /@media \(max-width: 760px\)[\s\S]*teacher-business-panel tbody tr[\s\S]{0,260}display:\s*grid/, "phone detail rows must become cards");
