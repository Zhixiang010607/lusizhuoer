...
- 小程序登录页使用黑、金、暖白品牌配色，微信手机号按钮保留微信绿。总部、门店、老师首页在相同手机内容视口下逐项复现网页版的模块顺序、字号、间距、颜色、圆角、按钮网格、表格列宽和滚动方式；微信状态栏、右上角胶囊、原生导航栏与浏览器地址栏属于平台差异。WXML/WXSS、小程序会话和微信能力仍与网页 HTML/CSS、浏览器会话物理隔离，禁止跨目录导入客户端源码。
