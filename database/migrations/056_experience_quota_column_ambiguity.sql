-- Migration 056: repair the shared verification writer after teacher quota
-- columns became PL/pgSQL output variables. All quota columns are explicitly
-- qualified so EXPERIENCE creation cannot fail with SQLSTATE 42702.
BEGIN;
