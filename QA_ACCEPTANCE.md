...
3. 小程序 `0.2.26` 已上传为开发版但尚未手动设为体验版、提交审核或正式发布。`0.2.27` 已通过全部 212 项测试，上传被微信代码上传白名单拒绝；加入开发机 IPv6 `2403:5816:9bbd:0:60f7:55e8:c409:fbd` 或关闭对应限制后，仍须重新上传并完成既有员工、拒绝授权、陌生手机号和封存员工四类真机验收。本轮没有修改云函数或 SQL，不生成新 ZIP／SQL 包。
