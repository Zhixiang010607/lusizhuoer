(() => {
  ...
  const access = {
    ...
    teacher: new Set(["teacher-work-orders.html", "change-password.html", "teacher-work-order-detail.html", "teacher-verification-create.html", "teacher-verification-supplemental.html", "teacher-recharge-create.html"])
  };
  let session = null;
  ...
  if (primaryNav) {
    ...
    if (session.role === "store") {
      ...
      const businessLinks = [["teacher-verification-create.html", "办理核销"], ["teacher-verification-supplemental.html", "补录核销"], ["teacher-recharge-create.html", "办理充值"]];
