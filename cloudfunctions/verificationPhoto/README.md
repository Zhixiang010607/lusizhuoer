...
4. 依次执行并验收 049、050；部署 `faceRecognition v77`、`staffAccount v66` 和 `teacherCreate v4` 后执行 053 并确认 7 行全部 `RETIRED`。删除旧 `reconcile-teacher-face-operations` Timer，保留老师额度月初 Timer。
