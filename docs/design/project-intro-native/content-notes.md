...
| 露思康辰 | `露思康辰～E脉通.pdf`，37 页 | 电磁热组成、可调温手柄、六个体验细节、须知中的禁用提醒 |
...
逐段通读的重点是：主语回到项目／技术／体验，每段有具体信息；避免反复命令顾客、重复提醒或用空泛句子凑长度。实际须知文本及默认折叠行为保持原样。

章节说明继续分段，六个体验细节保持两列短文；“返回登录”保留 17px、600 字重、52px 最小高度的暖色全宽按钮。配色、原创图、动效、导航及登录逻辑不变。本轮验收见 [产品文案验证](validation-product-copy.md)。
...
“体温管理”没有进入公开页，避免被理解为对人体核心体温或健康功能进行干预；使用“温度管理”描述可调温手柄与温热体验。露思康辰的疼痛、肿胀、麻木只保留在折叠体验须知中，用于提示已有持续不适者先就医并且不能以项目替代诊疗，不作为项目优势。
